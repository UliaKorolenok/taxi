@extends('layouts.app')
@section('title')
<title>Заказать такси Симферополь, междугороднее такси</title>
<meta name="description" content="ТаврияЮг - Трансферная служба междугороднего такси по Югу и центральной части России, СНГ" />
<meta name="keywords" content="такси симферополь, заказать такси в Симферополе,недорогое такси" />
<link href="https://tavria-ug.ru/simferopol" rel="canonical">
@endsection
@section('city')
Симферополь
@endsection
...
<div class="banner">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h1>
                   Междугороднее такси в Симферополе
                </h1>
...
<div class="tariffs">
    <div class="container">
    <h2>Тарифы такси в Симферополе</h2>
        <div class="row">
            <div class="col-3">
                <img src="public/images/standart-tariff.png" alt="Стандартный тариф такси в Симферополе" title="Стандартный тариф такси в Симферополе">
                <h3>Стандарт</h3>
                <p>Идеальный тариф для дальних поездок по приятной цене.</p>
            </div>
            <div class="col-3">
                <img src="public/images/comfort-tariff.png" alt="Тариф комфорт такси в Симферополе" title="Тариф комфорт такси в Симферополе">
                <h3>Комфорт</h3>
                <p>Просторный салон, водители имеют хорошие отзывы.</p>
            </div>
            <div class="col-3">
                <img src="public/images/business-tariff.png" alt="Бизнес тариф такси в Симферополе" title="Бизнес тариф такси в Симферополе">
                <h3>Бизнес</h3>
                <p>Автомобили премиум класса с высоким уровнем комфорта.</p>
            </div>
            <div class="col-3">
                <img src="public/images/minivan-tariff.png" alt="Такси минивэн в Симферополе" title="Такси минивэн такси в Симферополе">
                <h3>Минивэн</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-7">
                ...
                <p>Чтобы заказать такси в Симферополе, вам следует заполнить форму или обратиться к оператору и сообщить следующую информацию:</p>
                <ul>
                    <li>
