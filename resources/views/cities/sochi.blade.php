@extends('layouts.app')
@section('title')
<title>Заказать такси Сочи, междугороднее такси</title>
<meta name="description" content="ТаврияЮг - Трансферная служба междугороднего такси по Югу и центральной части России, СНГ" />
<meta name="keywords" content="такси сочи, заказать такси в Сочи,недорогое такси" />
<link href="https://tavria-ug.ru/sochi" rel="canonical">
@endsection
@section('city')
Сочи
@endsection
...
<div class="tariffs">
    <div class="container">
    <h2>Тарифы такси в Сочи</h2>
        <div class="row">
            <div class="col-3">
                <img src="public/images/standart-tariff.png" alt="Стандартный тариф такси в Сочи" title="Стандартный тариф такси в Сочи">
                <h3>Стандарт</h3>
                <p>Идеальный тариф для дальних поездок по приятной цене.</p>
            </div>
            <div class="col-3">
                <img src="public/images/comfort-tariff.png" alt="Тариф комфорт такси в Сочи" title="Тариф комфорт такси в Сочи">
                <h3>Комфорт</h3>
                <p>Просторный салон, водители имеют хорошие отзывы.</p>
            </div>
            <div class="col-3">
                <img src="public/images/business-tariff.png" alt="Бизнес тариф такси в Сочи" title="Бизнес тариф такси в Сочи">
                <h3>Бизнес</h3>
                <p>Автомобили премиум класса с высоким уровнем комфорта.</p>
            </div>
            <div class="col-3">
                <img src="public/images/minivan-tariff.png" alt="Такси минивэн в Сочи" title="Такси минивэн такси в Сочи">
                <h3>Минивэн</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-7">
                ...
                <p>Чтобы заказать такси в Сочи, вам следует заполнить форму или обратиться к оператору и сообщить следующую информацию:</p>
                <ul>
                    <li>
