@extends('layouts.app')
@section('title')
<title>Заказать такси Крым, междугороднее такси</title>
<meta name="description" content="ТаврияЮг - Трансферная служба междугороднего такси по Югу и центральной части России, СНГ" />
<meta name="keywords" content="такси крым, заказать такси в Крыму, заказать такси аэропорт, недорогое такси" />
<link href="https://tavria-ug.ru/" rel="canonical">
@endsection
@section('city')
Крым
@endsection
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <button><a href="#order" class="scrollOrder">Заказать такси</a></button>
            </div>
        </div>
    </div>
</div>
...
<div class="tariffs">
    <div class="container">
        <h2>Тарифы такси в Крыму</h2>
        <div class="row">
            <div class="col-3">
                <img src="public/images/standart-tariff.png" alt="Стандартный тариф такси по Крыму" title="Стандартный тариф такси по Крыму">
                <h3>Стандарт</h3>
                <p>Идеальный тариф для дальних поездок по приятной цене.</p>
            </div>
            <div class="col-3">
                <img src="public/images/comfort-tariff.png" alt="Тариф комфорт такси по Крыму" title="Тариф комфорт такси по Крыму">
                <h3>Комфорт</h3>
                <p>Просторный салон, водители имеют хорошие отзывы.</p>
            </div>
            <div class="col-3">
                <img src="public/images/business-tariff.png" alt="Бизнес тариф такси по Крыму" title="Бизнес тариф такси по Крыму">
                <h3>Бизнес</h3>
                <p>Автомобили премиум класса с высоким уровнем комфорта.</p>
            </div>
            <div class="col-3">
                <img src="public/images/minivan-tariff.png" alt="Такси минивэн по Крыму" title="Такси минивэн такси по Крыму">
                <h3>Минивэн</h3>
    ...
    <div class="container">
        <div class="row">
            <div class="col-7">
                ...
                <!--  <ul>
                    <li>Заполнить форму или позвонить по номеру телефона для оформления заказа.</li>
                    <li>Получить email подтверждение заказа с маркой и номером машины, а также итоговой стоимостью поездки</li>
                    <li>Ожидать приезд автомобиля в назначенный день и время</li>
                </ul>-->
                <p>Чтобы заказать такси, вам следует заполнить форму или обратиться к оператору и сообщить следующую информацию:</p>
                <ul>
                    <li>
                ...
                <p>
                    Чтобы <a href="#price" class="price scrollPrice">рассчитать стоимость такси</a>, можно заполнить форму, в которой указать место назначения
